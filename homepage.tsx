        ...
        return (
          <div className="font-mono text-sm">
            ...
            <div className="text-gray-300 ml-4 space-y-1">
              ...
              <div>-rw-r--r--  1 messier  staff  4096 Jan  1 00:00 <a href="https://github.com/maramasaeva/edgemarket" target="_blank" rel="noopener noreferrer" className="underline decoration-pink-400 underline-offset-2 hover:text-pink-400 transition-colors cursor-pointer">edgemarket</a> <span className="text-gray-500"># autonomous crypto trading bot — z-score spread arb on hyperliquid</span></div>
            </div>
